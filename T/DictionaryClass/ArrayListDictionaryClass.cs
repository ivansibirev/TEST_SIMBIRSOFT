...
namespace T
{
    public class ArrayListDictionaryClass
    {
        //public List<string> LS = new List<string>();
        public System.Collections.ArrayList LS = new System.Collections.ArrayList();        
        /// <summary>Конструктор + загрузка из файла</summary>
        public ArrayListDictionaryClass(string pathDictionary)
        {
